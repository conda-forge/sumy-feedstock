...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/sumy-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13203&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/sumy-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `sumy` can be installed with:

```
conda install sumy
```

It is possible to list all of the versions of `sumy` available on your platform with:
